$(function () {
    var ajaxUrlForAdminManage = "http://localhost:8080/course_selection_system/admin/adminManageServlet";
    var ajaxUrlForAdminInform = "http://localhost:8080/course_selection_system/adminServlet";
    ...
    $.getJSON(ajaxUrlForAdminManage, "action=getAdmin&charset=utf-8&id=" + getQueryString("id"), function (data) {
    ...
    $("#username").blur( function () {
        ...
        $.getJSON(ajaxUrlForAdminManage, "action=ajaxExistAdminUsername&username=" + username, function (data) {
            console.log(data);
