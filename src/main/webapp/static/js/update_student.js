$(function () {
    var ajaxUrlForStuManage = "http://localhost:8080/course_selection_system/admin/studentServlet";
    var ajaxUrlForStuInform = "http://localhost:8080/course_selection_system/userServlet";
    ...
    $.getJSON(ajaxUrlForStuInform, "action=ajaxSearchCollege&charset=utf-8", function (data) {
        console.log(data);
        var outputString = "";
    ...
    $.getJSON(ajaxUrlForStuInform, "action=ajaxSearchGrade&charset=utf-8", function (data) {
        console.log(data);
        var outputString = "";
    ...
    $.getJSON(ajaxUrlForStuManage, "action=getStudent&charset=utf-8&id=" + getQueryString("id"), function (data) {
        // 这里需要现关闭异步
    ...
    function getClasses(college, grade) {
        ...
        $.getJSON(ajaxUrlForStuInform, "action=ajaxSearchClasses&charset=utf-8&college=" + college + "&grade=" + grade, function (data) {
            console.log(data);
            var outputString = "";
    ...
    $("#stuNum").blur( function () {
        ...
        $.getJSON(ajaxUrlForStuInform, "action=ajaxExistStuNum&stuNum=" + stuNum, function (data) {
            console.log(data);
    ...
    $("#username").blur( function () {
        ...
        $.getJSON(ajaxUrlForStuInform, "action=ajaxExistStuUsername&username=" + username, function (data) {
            console.log(data);
